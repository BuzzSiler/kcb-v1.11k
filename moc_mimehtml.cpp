...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MimeHtml_t, stringdata) + ofs \
...
const QMetaObject MimeHtml::staticMetaObject = {
    { &MimeText::staticMetaObject, qt_meta_stringdata_MimeHtml.data,
      qt_meta_data_MimeHtml,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MimeHtml.stringdata))
