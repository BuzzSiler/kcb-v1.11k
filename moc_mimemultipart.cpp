...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MimeMultiPart_t, stringdata) + ofs \
...
const QMetaObject MimeMultiPart::staticMetaObject = {
    { &MimePart::staticMetaObject, qt_meta_stringdata_MimeMultiPart.data,
      qt_meta_data_MimeMultiPart,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MimeMultiPart.stringdata))
